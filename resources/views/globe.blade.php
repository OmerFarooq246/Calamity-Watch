...
<head>
  ...
  <script src='/assets/js/ImpactIndicator.js'></script>
...
Below the slider, detailed information regarding the disasters is represented in table format for the convenience of the user.</p>
    ...
    <div class="bot-btns container d-flex flex-row justify-content-center align-items-center mt-3 mb-5">
        <a class="btn" href="/{{$type}}/map">Map</a>
        <a class="btn disableClick" href="#">Globe</a>
    </div>
